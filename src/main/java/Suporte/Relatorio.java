...
public class Relatorio {
    ...
    public static void configurarRelatorioExtent(){
        ...
        CriarPasta.criarPastaParaRelatorio(CAMINHO_RELATORIO);
        ...
        htlmRelatorio.config().setTheme(Theme.STANDARD);
        htlmRelatorio.config().setEncoding("UTF-8");
